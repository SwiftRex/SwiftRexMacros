...
/// When the members are generated by the macro, which visibility modifier should be used.
public enum DeclarationVisibility: String {
...
/// Prism is a property with the same name as the case, but for the instance of the enum. If the instance points to that case, the variable will
/// return a tuple of all associated values of that case, or instance of Void `()` for case without associated values. However, if the instance
/// points to another case, it will return `nil`. This is extremely useful for using KeyPaths.
///
...
///
/// Setter
/// Prisms also produce setters. In that case, if the enum case has an associated value and you want to change the values in the tuple, that is
/// possible as long as the instance points to the same case, otherwise it will be ignored. For example:
/// ```swift
